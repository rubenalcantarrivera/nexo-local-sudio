...
export const metadata: Metadata = {
  title: "Ejemplos de páginas web por negocio",
  description: "Galería de ejemplos de páginas web para ópticas, clínicas, restaurantes, despachos, academias, veterinarias y otros negocios locales.",
  keywords: ["ejemplos de páginas web", "páginas web por negocio", "negocios locales", "Nexo Local Studio"]
};
    ...
    <main className="min-h-screen bg-brand-background">
      ...
      <section className="relative overflow-hidden border-b border-brand-border bg-paper">
        ...
        <div className="container-page relative grid gap-10 py-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-16">
          <div>
            <p className="eyebrow">Ejemplos por sector</p>
            <h1 className="mt-5 max-w-3xl font-display text-[clamp(2.45rem,4.8vw,4.6rem)] font-semibold leading-[0.98] text-brand-primary">
              Ejemplos de páginas web por tipo de negocio.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-brand-muted">
              Explora ejemplos de páginas para distintos negocios locales. Cada ejemplo muestra cómo podría verse una página clara, profesional y conectada a WhatsApp.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ButtonLink href={whatsappHref}>Solicitar una página para mi negocio</ButtonLink>
      ...
      <section className="container-page py-10">
        <div className="grid gap-5 border border-brand-border bg-white p-6 shadow-card lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <ButtonLink href={whatsappHref} variant="secondary">Cotizar mi página</ButtonLink>
        </div>
      </section>
      ...
      <AgencyCTA primaryHref={whatsappHref} title="Convierte un ejemplo en una página para tu negocio." description="Podemos adaptar el estilo, servicios, ubicación, fotografías y mensajes de contacto para presentar una página más cercana a tu negocio." />
      <Footer />
    </main>
  );
}
