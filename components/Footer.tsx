    ...
    <footer className={isClient ? "border-t border-brand-border bg-white" : "dark-grain texture-overlay relative overflow-hidden text-white"}>
      <div className="container-page grid gap-10 py-14 md:grid-cols-[1.25fr_0.75fr_0.9fr]">
        <div>
          ...
          <p className={isClient ? "mt-5 max-w-md text-sm text-brand-muted" : "mt-7 max-w-md text-sm text-white/78"}>{isClient ? "Servicios, ubicación y contacto directo para facilitar tu próxima visita." : "Estudio digital boutique para negocios locales. Creamos presencia digital clara, premium y conectada a WhatsApp."}</p>
        </div>
